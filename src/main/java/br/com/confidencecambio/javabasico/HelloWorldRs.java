...
public class HelloWorldRs {
    ...
    @RequestMapping(value = "/ola-mundo2", method = RequestMethod.GET)
    public ResponseEntity<String> teste(@RequestParam(value = "nome", required = false) String nome) {
        var retorno = "Ola2 " + service.retornaValorValido(nome);
        return new ResponseEntity<>(retorno, HttpStatus.OK);
    }
}
